      ...
      <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row justify-between items-center md:items-end gap-16">
        <div className="flex flex-col items-center md:items-start gap-8">
          ...
          <div className="flex gap-10 text-[10px] uppercase tracking-[0.3em] font-bold text-white/30">
            <a className="hover:text-primary transition-colors duration-300 interactive" href="#">Privacy</a>
            <a className="hover:text-primary transition-colors duration-300 interactive" href="#">Terms</a>
            <a className="hover:text-primary transition-colors duration-300 interactive" href="#">Registry</a>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center md:items-end">
          ...
          <div className="flex items-center gap-3 group cursor-default">
            <span className="text-2xl font-bold tracking-tighter uppercase transition-colors duration-300 group-hover:text-primary">Aurum</span>
            <div className="w-2 h-2 bg-primary rounded-full shadow-[0_0_12px_rgba(196,167,79,0.5)] transition-shadow duration-300 group-hover:shadow-[0_0_20px_rgba(196,167,79,0.8)]"></div>
          </div>
